...
/** Junction rows linking this group to its member contacts. */
fun ContactGroup.contactCrossRefs(): List<ContactGroupContactCrossRef> =
    contacts.map { contact ->
        ContactGroupContactCrossRef(groupId = id, contactLookupKey = contact.lookupKey)
    }
